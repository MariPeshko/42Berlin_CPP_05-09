...
int	main( void ) {
	...
	std::cout << max<int>(a, b) << std::endl;	// Excplicit instanciation
	std::cout << "Max of " << a << " and " << b << " is ";
	...
	std::cout << max<float>(c, d) << std::endl;	// Excplicit instanciation
	std::cout << "Max of " << c << " and " << d << " is ";
	...
	std::cout << max<char>(e, f) << std::endl;	// Excplicit instanciation
	std::cout << "Max of " << e << " and " << f << " is ";
